<#
.SYNOPSIS
    TrainLens Release Build — creates dist\TrainLens\ with no console window.

.DESCRIPTION
    Builds a release onedir distribution with console=False (windowed mode).
...
Write-Host "=== TrainLens Release Build ===" -ForegroundColor Cyan
...
# 5. Build
Write-Host "Building TrainLens (release, console=no)..." -ForegroundColor Green
$env:TRAINLENS_CONSOLE = "0"
